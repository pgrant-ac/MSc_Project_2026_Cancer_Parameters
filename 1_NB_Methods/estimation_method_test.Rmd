...
```{r rng, message=FALSE, warning=FALSE}
...
if (!file.exists("../1_NB_Methods/figs/fig_0.png")) {
  ...
  png("../1_NB_Methods/figs/fig_0.png",
...
```{r rng_summary, message=FALSE, warning=FALSE}
